  ...
  return (
    <div className="container" style={{ padding: "32px 16px" }}>
      ...
      <div className="dashboard-grid">
        ...
        <div className="glass-panel" style={{ justifySelf: "end", minWidth: "300px", padding: "16px 32px", display: "flex", alignItems: "center", justifyContent: "center", gap: "20px", borderTop: `4px solid ${user1?.primary_color || 'var(--user1-color)'}` }}>
        ...
        {/* Lado Direito - User 2 */}
        {user2 ? (
          <div className="glass-panel" style={{ justifySelf: "start", minWidth: "300px", padding: "16px 32px", display: "flex", alignItems: "center", justifyContent: "center", gap: "20px", borderTop: `4px solid ${user2?.primary_color || 'var(--user2-color)'}` }}>
