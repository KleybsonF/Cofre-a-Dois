  ...
  return (
    <div className="container" style={{ padding: "32px 16px" }}>
      ...
      <div className="dashboard-grid">
        ...
        <div className="glass-panel" style={{ padding: "24px", display: "flex", alignItems: "center", justifyContent: "flex-start", gap: "24px", borderTop: `4px solid ${user1?.primary_color || 'var(--user1-color)'}` }}>
        ...
        {/* Lado Direito - User 2 */}
        {user2 ? (
          <div className="glass-panel" style={{ padding: "24px", display: "flex", alignItems: "center", justifyContent: "flex-end", gap: "24px", borderTop: `4px solid ${user2?.primary_color || 'var(--user2-color)'}` }}>
